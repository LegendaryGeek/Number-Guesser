...
public class Geeks_Main {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// any. =)
		System.out.println(
				"[" + java.time.LocalDateTime.now() + "] " + "Current App State: " + Geeks_Main.getState().toString());
		game = new LG_Frame();
		setRand(new Random());
	...
	public enum State {
		WAIT("wait"), LOST("Lost Game"), PLAYING("Playing"), WON("Won Game"), EXIT("Exiting Game"),
		START("Starting Game");
